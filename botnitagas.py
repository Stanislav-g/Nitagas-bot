...
async def color_role(ctx):
    ...
    role = discord.utils.get(ctx.guild.roles, id= roleid) #name="Участник"
...
async def tempmute(ctx, amount : int = None, member: discord.Member = None, * ,reason = None):
    ...
    elif roler in ctx.author.roles:
        if amount == None:
            await ctx.send('Правильное использование команды: -tempmute (время в секундах) (@пользователь) (причина)')
        elif member == None:
            await ctx.send('Правильное использование команды: -tempmute (время в секундах) (@пользователь) (причина)')
    ...
    elif rolerr in ctx.author.roles:
        if amount == None:
            await ctx.send('Правильное использование команды: -tempmute (время в секундах) (@пользователь) (причина)')
        elif member == None:
            await ctx.send('Правильное использование команды: -tempmute (время в секундах) (@пользователь) (причина)')
    ...
    elif rolet in ctx.author.roles:
        if amount == None:
            await ctx.send('Правильное использование команды: -tempmute (время в секундах) (@пользователь) (причина)')
        elif member == None:
            await ctx.send('Правильное использование команды: -tempmute (время в секундах) (@пользователь) (причина)')
