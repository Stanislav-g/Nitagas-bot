...
async def country( ctx, arg ):  
	...
	if num < 100:
		...
		if num > num2:
			...
			if num2 > num3:
			    print('1', randomflag, num,'%')
			    print('2', randomflag2, num2,'%')
			    print('3', randomflag3, num3,'%')
			else:
			    print('1', randomflag, num,'%')
			    print('2', randomflag2, num3,'%')
			    print('3', randomflag3, num2,'%')

		    else:
			print('1', randomflag, num3,'%')
			print('2', randomflag2, num,'%')
			print('3', randomflag3, num2,'%')
		elif num2 > num:
		    if num2 > num3:
			if num > num3:
			    print('1', randomflag, num2,'%')
			    print('2', randomflag2, num,'%')
			    print('3', randomflag3, num3,'%')
			else:
			    print('1', randomflag, num2,'%')
			    print('2', randomflag2,num3,'%')
			    print('3', randomflag3, num,'%')       
