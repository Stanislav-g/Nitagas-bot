...
async def e(ctx ):
    ...
    url = 'https://drive.google.com/drive/folders/1' + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + str(a).replace(' ', '+') + '?usp=sharing'
    await ctx.send( url )  
